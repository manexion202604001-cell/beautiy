...
// SQUARE webhook: raw body is required for signature verification. Optional ?k=<Integration.webhookKey>
...
export async function POST(req: NextRequest) {
  ...
  const r = await handlePaymentWebhook('SQUARE', raw, req.headers, new URL(req.url));
